...
def demonstrate_interactive_combat():
    ...
    print("✅ Player chooses weapon on each turn")
    print("✅ Multiple weapon options (unarmed, improvised, equipped weapons)")
    print("✅ Weapon stats affect attack bonus and damage")
    print("✅ Monsters act automatically")
    print("✅ Combat continues until victory/defeat")
    print()
