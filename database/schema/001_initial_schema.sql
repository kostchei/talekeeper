...
CREATE TABLE character_features (
    ...
    source TEXT, -- legacy column for older data imports
    feature_id INTEGER, -- references unified class feature tables when available
    feature_source TEXT, -- 'class', 'subclass', 'feat', 'item', etc.
    feature_data TEXT, -- JSON blob for structured metadata
...
CREATE TABLE equipment (
    ...
    created_at TEXT DEFAULT CURRENT_TIMESTAMP
, attunement_requirement TEXT DEFAULT NULL);
...
CREATE TABLE classes (
            ...
            , weapon_proficiencies TEXT DEFAULT NULL, armor_proficiencies TEXT DEFAULT NULL, item_proficiencies TEXT DEFAULT NULL);
...
CREATE TABLE campaigns (
                    ...
                    rest_rules TEXT,
                    style TEXT
                , available_classes TEXT DEFAULT '[]', monster_alignment_rules TEXT DEFAULT '{}');
...
CREATE TABLE item_rarity_table (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX idx_rarity_level_range ON item_rarity_table(min_level, max_level);
CREATE INDEX idx_rarity_roll ON item_rarity_table(roll_min, roll_max);
