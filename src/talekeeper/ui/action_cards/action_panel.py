...
from talekeeper.ui.action_cards.weapon_mastery_dialog import WeaponMasteryDialog
from talekeeper.ui.action_cards.divine_smite_dialog import DivineSmiteDialog
from talekeeper.ui.action_cards.lay_on_hands_dialog import LayOnHandsDialog
from talekeeper.ui.action_cards.channel_divinity_dialog import ChannelDivinityDialog, create_channel_divinity_options
...
class ActionPanel(QWidget):
    ...
    def _trigger_rogue_action(self, action_type):
        ...
        try:
            from talekeeper.services.rogue_abilities import RogueAbilitiesService
    ...
    def _calculate_hit_bonus(self, weapon: Dict[str, Any], hand: str) -> int:
        ...
        from talekeeper.services.proficiency_bonus import get_proficiency_bonus_from_context
    ...
    def _roll_attack(self, context: Dict[str, Any]) -> tuple[int, dict]:
        ...
        from talekeeper.services.advantage_system import advantage_system, RollType, AdvantageState
    ...
    def _check_concentration_save(self, character_id: str, damage: int):
        ...
        try:
            from talekeeper.services.concentration_system import get_concentration_system
    ...
    def _ensure_combat_session(self):
        ...
        try:
            from talekeeper.ui.encounter_pane.encounter_panel import CombatSession
        except Exception as e:
    ...
    def _check_divine_smite(self, is_critical: bool, target_monster: Any, context: Dict[str, Any], base_damage: int = 0) -> Tuple[int, int]:
        ...
        try:
            from talekeeper.services.spellcasting_service import get_spellcasting_service
