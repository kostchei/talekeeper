...
from talekeeper.services.skill_challenge_rewards import SkillChallengeRewards
from talekeeper.services.campaign_description_service import CampaignDescriptionService
from talekeeper.services.combat_log_parser import CombatLogParser
from talekeeper.services.stealth_mechanics import StealthMechanicsService
...
class CombatSession:
    ...
    def start_combat_with_action_economy(self, character_id: str):
        ...
        from talekeeper.models.action_economy import CombatActionEconomy
...
class EncounterPanel(QWidget):
    ...
    def _load_class_data(self):
        """Load class data from talekeeper.database."""
        try:
            import sqlite3
            conn = sqlite3.connect("talekeeper.db")
    ...
    def _load_feats_data(self):
        """Load available feats from talekeeper.database."""
        try:
            import sqlite3
            conn = sqlite3.connect("talekeeper.db")
            cursor = conn.cursor()
    ...
    def _generate_monster_encounter(self):
        ...
        try:
            ...
            try:
                from talekeeper.ui.encounter_pane.encounter_generator import XP_BUDGETS
    ...
    def _get_monster_image_path(self, monster_name: str) -> Optional[str]:
        ...
        try:
            ...
            campaign_images_dir = get_data_path(os.path.join("images", "monsters", campaign_folder))
            ...
            generic_images_dir = get_data_path("images")
            for ext in ['.png', '.jpg', '.jpeg', '.gif', '.bmp']:
    ...
    def _roll_equipment_drops(self, monster_name: str, monster_cr) -> list:
        ...
        try:
            ...
            for _ in range(num_items):
                # Pass dropped_item_names to exclude already dropped items this cycle
                item = loot_service.drop_loot(character_id, character_data, rarity, exclude_items=dropped_item_names)
    ...
    def _add_items_to_character(self, items: list):
        """Add dropped items to character inventory and auto-equip if better."""
    ...
    def _generate_hoard_magic_items(self, count: int, monster_cr: float) -> list:
        ...
        from talekeeper.services.treasure_rarity import TreasureRaritySystem
        import random
