...
try:
    from talekeeper.services.condition_manager import ConditionManager, ConditionType, ConditionEffects
except ImportError:
...
class ConditionStatService:
    ...
    def get_character_base_speed(self, character_id: str) -> int:
        """Get character's base movement speed from talekeeper.database."""
        try:
